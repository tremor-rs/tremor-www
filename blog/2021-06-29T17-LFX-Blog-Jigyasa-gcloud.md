...
I wrote a GCS sink that can issue the basic GCS Operations such as list buckets and objects, create, insert and delete objects from the Google Cloud Platform cloud storage service. The docs can be found here: [GCS offramp docs](/docs/connectors/offramps/#gcs)
...
[gpub offramp](/docs/connectors/offramps/#gpub) and [gsub onramp](/docs/connectors/onramps/#gsub)
...
Supported preprocessors, that can be configured in yaml file can be found here: [preprocessors](/docs/connectors/preprocessors/). Supported postprocessors and more about it: [postprocessors](/docs/connectors/postprocessors/).
Supported codecs, that can be configured in yaml file can be found here: [codecs](/docs/connectors/codecs/)
...
```
For a detailed guide on the Operations that can be performed, refer the [docs](/docs/connectors/offramps/#gcs).
...
Supported preprocessors, that can be configured in yaml file can be found here: [preprocessors](/docs/connectors/preprocessors/).
Supported postprocessors and more about it: [postprocessors](/docs/connectors/postprocessors/). 
Supported codecs, that can be configured in yaml file can be found here: [codecs](/docs/connectors/codecs/)
...
Refer to the [gpub](/docs/connectors/offramps/#gpub) and [gsub](/docs/connectors/onramps/#gsub) docs to perform opertaions.
