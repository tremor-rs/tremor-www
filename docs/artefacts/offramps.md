...
It is recommended to batch events sent to this sink using the [generic::batch operator](../scripting/tremor-query/operators.md#genericbatch) to reduce the overhead
