...
* [Apache Log](/docs/recipes/logstash/README/)- storing apache logs in elastic search.
* [Influx Aggregation](/docs/recipes/influx/README/)- aggregating metrics for InfluxDB.
