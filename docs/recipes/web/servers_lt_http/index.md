...
Example tremor based HTTP server control application

## Setup

:::tip
All the code here is available in the [git repository](https://github.com/tremor-rs/tremor-www/tree/main/docs/recipes/servers_lt_http) as well.
:::
...
Assuming you have all the code from the [git repository](https://github.com/tremor-rs/tremor-www/tree/main/docs/recipes/servers_lt_http), run the following to start our application:
...
This is utilizing the pipeline [state mechanism](../../../language/scripts/overview#state) under the hood -- a powerful way to build stateful applications.
