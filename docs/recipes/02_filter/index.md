...
The `filter` builds on the [passthrough example](/docs/recipes/passthrough/index) and extends the [`example.trickle`](etc/tremor/config/example.trickle) by adding a filter
