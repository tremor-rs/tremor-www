...
See also:
 ...
 - [`std::string::into_binary`](../stdlib/std/string#into_binarybytes) and [`std::string::from_utf8_lossy`](../stdlib/std/string#from_utf8_lossybytes)
...
DocComment Grammar:
> ![doc comment grammar](../reference/svg/doccomment.svg)
