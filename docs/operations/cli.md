...
|----|------|----|--------|-----------|
|verbose|None|switch/flag|no|Sets the level of verbosity (does not apply to logging)|
...
|Name|Switch|Kind|Multiple|Description|
|----|------|----|--------|-----------|
|artefacts|None|switch/flag|no|Paths to files containing pipelines, onramps, offramps to provision|
