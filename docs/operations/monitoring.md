...
- If your pipeline is using the [batch operator](../scripting/tremor-query/operators.md#genericbatch) and offramp is receiving events from it, no of events tracked at offramp is going to be dictated by the batching config.
...
- [grouper::bucket](../scripting/tremor-query/operators.md#grouperbucket)
