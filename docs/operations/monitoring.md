...
- If your pipeline is using the [batch operator](../language/queries/operators#genericbatch) and offramp is receiving events from it, no of events tracked at offramp is going to be dictated by the batching config.
