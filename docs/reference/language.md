...
|[tremor-deploy](language/deploy)| - The tremor deployment language.|troy|
|[tremor-query](language/query)| - The tremor query language.|trickle|
|[tremor-script](language/script)| - the tremor scripting language.|script|
