...
connect "/connector/my-file-connector/out" to "/pipeline/passthrough/in";
connect "/pipeline/passthrough/out" to "/connector/stdio/err";
```
...
```
disconnect "/connector/my-file-connector/out" from "/pipeline/passthrough/in";
```
